...
public class Cookie {
  ...
  /**
   * Initializes a new cookie. If not type is specified, the default cookie type
   * is a sugar cookie.
   */
  public Cookie() {
    this("sugar");
  ...
  /**
   * Counts the number of calories in a batch of cookies. Arbitrarily, we assume
   * that each ingredient has 100 calories.
   * 
  ...
  /**
   * Returns a {@link String} representation of the list of ingredients.
   * 
   * @return a {@link String} representation of the list of ingredients
   */
   ...
   * @return {@code true} if cookie type starts with "chocolate"
   */
